...
public class ModModelPredicateProvider {
    ...
    public static void registerEnderShadowshotBow (Item bow){

        FabricModelPredicateProviderRegistry.register(ModItems.ENDER_SHADOWSHOT_BOW, new Identifier("pull"), (stack, world, entity, seed) -> {
            if (entity == null) {
                return 0.0F;
            } else {
                return entity.getActiveItem() != stack ? 0.0F : (float)(stack.getMaxUseTime() - entity.getItemUseTimeLeft()) / 20.0F;
